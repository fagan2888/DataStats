...
def tong_bi_ten_days(sh, sql):
    ...
    for name in names:
        ...
        if name == "分公司整体":
            wei_xin_str += f"领导，你好！\n"\
                f"截至{idate.end_date[5:7]}月{idate.end_date[8:]}日，分公司整体签单保费{zheng_ti.this_year_limit:.2f}万元，"\
                f"同比增长率{zheng_ti.year_tong_bi_limit:.2%}，其中：\n"\
                f"车险签单保费{che.this_year_limit:.2f}万元，同比增长率{che.year_tong_bi_limit:.2%} \n"\
                f"人身险签单保费{ren_shen.this_year_limit:.2f}万元，同比增长率{ren_shen.year_tong_bi_limit:.2%}\n"\
                f"财产险签单保费{cai_chan.this_year_limit:.2f}万元，同比增长率{cai_chan.year_tong_bi_limit:.2%}\n"
    ...
    for name in names:
        ...
        if name == "分公司整体":
            wei_xin_str += f"{idate.end_date[5:7]}月分公司整体签单保费{zheng_ti.this_year_month_limit:.2f}万元，同比增长率{zheng_ti.month_tong_bi_limit:.2%}，"\
                f"其中：\n"\
                f"车险签单保费{che.this_year_month_limit:.2f}万元，同比增长率{che.month_tong_bi_limit:.2%} \n"\
                f"人身险签单保费{ren_shen.this_year_month_limit:.2f}万元，同比增长率{ren_shen.month_tong_bi_limit:.2%}\n"\
                f"财产险签单保费{cai_chan.this_year_month_limit:.2f}万元，同比增长率{cai_chan.month_tong_bi_limit:.2%}\n"
    ...
    for name in names:
        ...
        if name == "分公司整体":
            wei_xin_str += f"{idate.begin_date[5:7]}月{idate.begin_date[8:]}日至{idate.end_date[8:]}日期间分公司整体签单保费{zheng_ti.this_ten_days:.2f}万元，"\
                f"同比增长率{zheng_ti.ten_days_tong_bi:.2%}，其中：\n"\
                f"车险签单保费{che.this_ten_days:.2f}万元，同比增长率{che.ten_days_tong_bi:.2%}\n"\
                f"人身险签单保费{ren_shen.this_ten_days:.2f}万元，同比增长率{ren_shen.ten_days_tong_bi:.2%}\n"\
                f"财产险签单保费{cai_chan.this_ten_days:.2f}万元，同比增长率{cai_chan.ten_days_tong_bi:.2%}\n"
        nrow += 1
