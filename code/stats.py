...
class Stats(object):
    ...
    def ji_gou_fan_wei(self):
        if self.name == "分公司整体":
            ...
            value = "[销售团队] = '01141101010002张笑晓团队' or [销售团队] =  '01141127010001沾益支公司团队' \
                or [销售团队] = '01141127010002沾益支公司' or [销售团队] = '01141127010003沾益支公司1'"
        elif self.name == "祥云":
            value = "[销售团队] = '141200000001大理中支一部' or [销售团队] =  '01141723010001祥云支公司' \
                or [销售团队] = '01141723010001祥云支公司团队'"
        elif self.name == "曲靖营业一部":
            value = "[销售团队] = '01141101010001李雄团队' or [销售团队] =  '01141101010004曲靖中支销售一部'"
        elif self.name == "曲靖中支本部":
            value = "[销售团队] = '01141101010003曲靖中支销售部（虚拟）' or [销售团队] =  '140200000001中支业务部' \
                or [销售团队] = '140200010001虚拟业务二部' or [销售团队] = '0114110101曲靖中心支公司营业一部（虚拟）'"
        elif self.name == "大理中支本部":
            value = "[销售团队] = '01141701010001营业二部销售团队' or [销售团队] =  '0114170101大理中心支公司营业一部（虚拟）'"
        elif self.name == "分公司本部":
            value = "[机构] = '0114010101云南分公司营业一部（虚拟）' or [机构] =  '0114010110云南分公司航旅出行项目（虚拟）'"
        else:
